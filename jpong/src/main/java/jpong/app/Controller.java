    ...
    public void initialize() {
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < columns; c++) {
                ...
                int[] connected = check_nodes.show_all_node();
                double[] weights = check_nodes.show_all_weights();
        ...
        if (columns < 4 || rows < 4) {
            ...
            grid_container.setBackground(
                    new Background(new BackgroundFill(slider_background, CornerRadii.EMPTY, Insets.EMPTY)));
